...
export interface Homepage {
  id: number;
  /**
   * Images or videos for the hero section carousel. Upload via Media first, then select here.
   */
  heroMedia?:
    | {
        /**
         * Image or video from Media library
         */
        media: number | Media;
        /**
    ...
    | null;
  /**
   * Images for the highlight moments section on the homepage.
   */
  highlights?:
    | {
        image: number | Media;
        /**
         * Caption shown on hover (e.g. 'hackathon night')
         */
        caption?: string | null;
        id?: string | null;
      }[]
